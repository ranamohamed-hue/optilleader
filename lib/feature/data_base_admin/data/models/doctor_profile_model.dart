class DoctorProfileModel {
  ...
  final String profileImage; // الحقل الجديد
  // بيانات التواصل
  final String email;
  final String phone;
  ...
  final bool isActive; // <--- المتغير الجديد للتحكم في الحساب
  ...
  DoctorProfileModel({
    ...
    this.isActive = true, // افتراضياً الحساب نشط عند الإنشاء
  ...
  factory DoctorProfileModel.fromJson(Map<String, dynamic> json, String id) {
    return DoctorProfileModel(
      ...
      birthDate: json['identity']['birth_date'] != null
          ? DateTime.parse(json['identity']['birth_date'])
          : null,
          profileImage: json['contact']?['profile_image_url'] ?? '',
      ...
      isActive: json['eligibility_data']['is_active'] ?? true, // قراءة الحالة من فايربيز
  ...
  Map<String, dynamic> toMap() {
    return {
      'uid': uid ?? '', // يفضل تمرير الـ UID الفعلي
      'role': 'doctor',
      'isFirstLogin': true,
      'isRegistered': true,
      'identity': {
      ...
      'eligibility_data': {
        ...
        'is_active': isActive, // حفظ الحالة في فايربيز
      },
      'scientific_work': {
  ...
  DoctorProfileModel copyWith({
    ...
    String? cvUrl,
    bool? isOnVacation,
    bool? isActive, // إضافة القدرة على تعديل الحالة
  }) {
    return DoctorProfileModel(
      uid: this.uid,
      nameAr: this.nameAr,
      ...
      currentJobAr: this.currentJobAr,
      currentJobEn: this.currentJobEn,
      socialStatusAr: this.socialStatusAr,
      socialStatusEn: this.socialStatusEn,
      ...
      hasPermanentPosition: this.hasPermanentPosition,
      isOnVacation: isOnVacation ?? this.isOnVacation,
      isActive: isActive ?? this.isActive, // تحديث الحالة
