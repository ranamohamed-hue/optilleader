      ...
      body: FutureBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          if (deadlineTimestamp != null) {
            formattedDeadline = DateFormat('EEEE, d MMMM yyyy', currentLang).format(deadlineTimestamp.toDate());
          }
          
          String postedDate = '';
          if (createdAtTimestamp != null) {
            postedDate = DateFormat('d MMM yyyy', currentLang).format(createdAtTimestamp.toDate());
          }

          return Scaffold(
            backgroundColor: theme.scaffoldBackgroundColor,
            //  زرار التقدم للوظيفة/الفرصة
            floatingActionButton: FloatingActionButton.extended(
              onPressed: () {
                // هنا هنحط لوجيك التقدم بعدين
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('announce.details.apply_success'.tr()), 
                        ...
                        if (imageUrl != null)
                          CachedNetworkImage(
                            ...
                            errorWidget: (context, url, error) => Container(
                              ...
                              child: Icon(Icons.broken_image_outlined, color: colorScheme.primary, size: 40.sp),
                            ),
                          ),
                        Container(
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
                              ...
                              colors: [
                                Colors.black.withOpacity(imageUrl != null ? 0.3 : 0.0),
                                colorScheme.primary.withOpacity(imageUrl != null ? 0.8 : 1.0),
                              ],
                            ),
                          ),
                        ),
                        Padding(
                          // ✅ تصغير الـ Padding العلوي عشان الشريط يبقى أصغر
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "common.app_name".tr(),
                                      style: theme.textTheme.bodySmall?.copyWith(color: colorScheme.secondary.withOpacity(0.9)),
                                    ),
                                  ],
                                ),
                              ),
                              // ✅ الأيقونة اتنقلت على الجهة التانية
                              Container(
                                ...
                                child: CircleAvatar(
                                  ...
                                  child: Icon(Icons.campaign_rounded, color: Colors.white, size: 24.sp),
                                ),
                              ),
                            ],
                          ),
                ...
                SliverPadding(
                  ...
                  sliver: SliverList(
                    delegate: SliverChildListDelegate([
                      ...
                      SizedBox(height: 100.h), // مسافة عشان الزرار اللي تحت ميطيش على الكارد
                    ]),
                  ),
                ),
              ],
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            top: -15,
            child: Icon(Icons.campaign_rounded, size: 130.sp, color: colorScheme.secondary.withOpacity(0.04)),
          ),
          Padding(
