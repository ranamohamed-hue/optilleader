      ...
      children: [
        Row(
          ...
          children: [
            ...
            TextButton(
              onPressed: () => context.push('/judge/orders-list', extra: {}),
  ...
  Widget _buildBottomNav(Color navy, Color gold, String uid, String role) {
    return BottomNavigationBar(
      ...
      onTap: (index) {
        switch (index) {
          case 0: break;
          case 1: context.push(Routes.notification); break;
          case 2: context.push('/judge/orders-list'); break;
          case 3: context.push(Routes.settings, extra: {'uid': uid, 'role': role}); break;
        }
      },
      items: [
